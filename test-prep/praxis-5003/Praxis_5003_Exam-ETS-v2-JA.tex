...
\item [\ansE]$\left(4\times\mbox{1,000}\right)+\left(3\times100\right)+\left(7\times1\right)+\left(6\times\frac{1}{10}\right)+\left(7\times\frac{1}{100}\right)$
...
\item [\ansE]$w$ is the independent variable, and $n$ is the dependent
variable.
...
\item [\ansE]$T\,\colon\left(C+T\right)=3\,\colon4$
...
\item [\ansB]The median is 22 years.
\item [\ansB]The mean is 23 years.
...
\item [\ansE]$\frac{1}{3}\times\frac{1}{9}$
...
\item [\ansE]Ten-thousandths place
...
\begin{itemize}
\item [\ansB]The first term is 2. Each subsequent term of the sequence
...
\item [\ansE]$x$ is in the tens place, and $y$ is in the hundredths place.
\yspace \vfill
\end{itemize}
...
\item [\ansE]Both angles are acute.
...
\item [\ansE]$0.44$, $0.\bar{44}$, $\frac{13}{22}$, $\frac{3}{5}$
...
stay the same.
\item [\ansE]The mean and range of the data set will change, but the median
will stay the same.
...
\item [\ansE]1,409.1 and 1,409.1474
...
\item [\ansE]$\dfrac{6.9}{100}=\dfrac{t}{899.99}$
...
\item [\ansE]$2y\left(x+1\right)$\yspace \vfill
\end{itemize}
...
\item [\ansB]The variables are $x$ and $y$.
\item There are like terms.
\item [\ansB]There are five terms.
\item [\ansB]The degree of the expression is 3.\yspace \vfill
\end{itemize}
\item \questMultiPic 
\begin{figure}[H]
...
\begin{itemize}
\item Less than 20
\item [\ansE]Between 20 and 24 cups. 
...
\end{figure}
\begin{figure}[H]
\begin{center}\begin{tikzpicture} [scale=.75, thick]   	
...
\item [\ansE]2289 square inches\yspace \vfill
\end{itemize}
\item \questMultiPic 
\begin{figure}[H]
\[
...
\item [\ansE]$17x^{3}$ and $30x^{3}$\yspace \vfill
\end{itemize}
\item \questMultiPic 
\begin{figure}[H]
\begin{tabular}{|c|>{\centering}m{3cm}|}
...
\begin{itemize}
\item $8+20$
\item [\ansE]$\left(2+5\right)\times4$
...
\item [\ansE]1, 2, 3, 4, 6, 9, 12, 18, 36\yspace \vfill
\end{itemize}
\item \questMultiPic 
\begin{figure}[H]
\begin{tikzpicture}[scale=1.0]     
...
\item [\ansE]$\overrightarrow{ZX}$ and $\overrightarrow{ZY}$
