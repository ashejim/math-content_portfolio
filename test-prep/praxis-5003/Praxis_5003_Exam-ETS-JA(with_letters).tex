...
fraction increases.
\item  \ans When the numerator stays the same and the denominator increases,
...
\begin{enumerate}
\item  \ans $F$ lies on the y -axis.
\item $B$ lies on the $x$-axis.
\item $A$ is in the first quadrant.
\item  \ans $E$ is in the fourth quadrant
