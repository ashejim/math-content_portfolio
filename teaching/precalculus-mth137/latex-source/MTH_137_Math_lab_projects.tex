...
\newcommand{\examType}{Math Lab Project}
...
\section*{\textbf{Quadratic Function Project}}
...
the photo; a free photo editor \hyperref[http://www.gimp.org/downloads/]{http://www.gimp.org/downloads/}).
...
\item Use two other points on the graph to check your equation (it only
needs to be an approximation). \vfill
