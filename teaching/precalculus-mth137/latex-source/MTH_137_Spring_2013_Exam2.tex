...
\begin{enumerate}[resume]
\item $f(x)=-\frac{1}{3}x+1$\vfill\vspace{1.5cm}
\end{enumerate}
\emph{Let $f(x)=x+4$ and $g(x)=x^{2}-x$. Find and simplify the expression. }
\begin{enumerate}[resume]
\item $(f+g)(-6)$\vfill
\item $\left(g\circ f\right)(2)$\vfill
\end{enumerate}
...
\begin{enumerate}[resume]
\item \emph{$\left(f\circ g\right)(x)$}\vfill
\item \emph{$\left(g\circ f\right)(x)$}\vfill
\item Is $g$ the inverse of $f$?
\end{enumerate}
\end{enumerate}
