...
\begin{enumerate}
\item Write the following set in tabular form: $A=\{x\colon x\mbox{ is a letter in "do not repeat"}\}$.

\begin{enumerate}
\item []$A=\{d,o,n,t,r,e,p,a\}$\vfill
\end{enumerate}
\item Write the following set in tabular form: $B=\{x\colon x=2n\mbox{ for }n\in\mathbb{Z}\}$.

\begin{enumerate}
\item []$\{\dots,-2,-1,0,1,2,\dots\}$\vfill
\end{enumerate}
...
\begin{enumerate}[resume]
\item []A \emph{function }is a rule that assigns each element in one set
to one and only one element in another set.\vfill
\end{enumerate}
\end{enumerate}
\begin{enumerate}
...
\begin{enumerate}
\item []A function is one to one if $f(a)=f(b)$ implies that $a=b$.\vfill
\end{enumerate}
\item A \emph{transitive relation.}

\begin{enumerate}
\item A relation is \emph{transitive }if $a\mathcal{R}b$ and $b\mathcal{R}c$
implies that $a\mathcal{R}c$.\vfill
\end{enumerate}
\end{enumerate}
...
\begin{enumerate}
\item Is $16\equiv4\bmod12$?

\begin{enumerate}
\item []Yes: $12|(16-4)$
\end{enumerate}
\item Is $5\equiv4\bmod12$?

\begin{enumerate}
\item []No: $12\cancel{|}(5-4)$
\end{enumerate}
\item Find an integer $x$ such that $0\leq x<4$ and $x\equiv15\bmod4$.
