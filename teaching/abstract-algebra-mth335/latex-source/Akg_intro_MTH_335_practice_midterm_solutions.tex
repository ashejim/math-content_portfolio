...
for any $k\in\left\{ 0,1,2,3,\dots\right\} $ since $2|17-(2k+1)$.\vfill
\item $\mbox{lcm}(7^{4000}\cdot5^{2}\cdot2^{4},7^{4}\cdot5^{1000}\cdot2)$

$\mbox{lcm}(7^{4000}\cdot5^{2}\cdot2^{4},7^{4}\cdot5^{1000}\cdot2)=7^{4000}\cdot5^{1000}\cdot2^{4}$\vfill
...
\end{proof}
\item Let $A\neq\emptyset$ be a subset of $B$. Prove or disprove that
$A=A\cup B$..
