...
$g(f(a)=c$. So $g\circ f$ is a function.\vfill
\end{proof}
\item Let $f:A\rightarrow A$, $g:A\rightarrow A$, and $h:A\rightarrow A$;
prove that $\left(h\circ g\right)\circ f=h\circ\left(g\circ f\right)$.
