...
\begin{enumerate}
\item []$A=\left\{ x|x=3n\mbox{ for }n\in\mathbb{Z}\right\} $
\end{enumerate}
\end{enumerate}
...
\item Find $A\times B=\left\{ \left(1,2\right),\left(1,4\right),\left(2,2\right),\left(2,4\right)\right\} $
\end{enumerate}
...
So $x\in A$ or $x\in A$. Thus $A\cup A\subseteq A$.
\end{proof}
\item Let $A\subseteq B$ and $B\subseteq C$. Prove that $A\subseteq C$.\vfill
\item Give the definition of the following:

\begin{enumerate}
\item A \emph{1-1 function}.\vspace{\Dspace}\vspace{\Dspace}\vspace{\Dspace}
