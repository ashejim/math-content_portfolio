...
\emph{You must show work to receive credit. If using the TVM solver,
indicate Each problem is worth 9 points.}
...
\item \$2500 at 7\% compounded continuously for 5 years.\vfill
\end{enumerate}
...
made at the end of each year for 12 years. \\
\begin{tabular}{rl}
\textbf{N:} & \tabularnewline
${\tt I\%}$: &  \tabularnewline
${\tt PV}$: &  \tabularnewline
...
\begin{enumerate}[resume]
\item Payments of \$100 each month for 10 years at 8.5\%.\\
\begin{tabular}{rl}
\textbf{N:} & \tabularnewline
${\tt I\%}$: &  \tabularnewline
${\tt PV}$: &  \tabularnewline
...
paid. }
\begin{enumerate}[resume]
\item \$175,000 at 6.24\% for 30 years.\\
\begin{tabular}{rl}
\textbf{N:} & \tabularnewline
${\tt I\%}$: &  \tabularnewline
${\tt PV}$: &  \tabularnewline
