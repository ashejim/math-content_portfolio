...
{\displaystyle } & = & \int_{0}^{9}\cancel{x^{2}}u^{4}\frac{du}{3\cancel{x^{2}}}\\
 & = & \frac{1}{3}u^{4}|_{0}^{9}=\frac{9^{4}}{3}-0=\frac{9^{4}}{3}\\
 & = & \frac{6561}{3}=2187
\end{eqnarray*}
\vfill
\begin{enumerate}
...
\begin{eqnarray*}
 ...
 & = & -\frac{1}{2}\left(\frac{2}{1}\right)u^{\nicefrac{1}{2}}|_{0}^{3}=-\sqrt{3}\,\,(\approx1.73205)
\end{eqnarray*}
\vfill
...
\vfill
\begin{enumerate}[resume]
\item Find the total distance traveled over the given interval. \vfill
\end{enumerate}
...
\[
\pi{\displaystyle {\displaystyle \int}_{-4}^{0}\left[\left(-16x\right)^{2}-\left(8x^{2}+x^{3}\right)^{2}\right]\,dx=\frac{32768}{35}}
\]
\vfill
