...
\begin{axis}[height=5cm, 
	...
	\addplot[dashed,very thick,blue] coordinates{(.5,0) (.5,4)};
	\addplot[dashed,very thick,blue] coordinates{(1,0) (1,2)};
...
\begin{axis}[height=5cm, 
	...
	\addplot+[domain=0:pi/2,fill,black!30!white]{sqrt(sin(x))} \closedcycle;
	
	\addplot[domain=0:pi/2,thick,smooth,samples=500]{\sin(x)}; 
