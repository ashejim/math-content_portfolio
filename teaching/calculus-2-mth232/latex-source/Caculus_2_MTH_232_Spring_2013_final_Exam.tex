...
\renewcommand{\date}{\formatdate{15}{5}{2013}}
...
\newcommand{\samples}{500}\textbf{No credit will be given unless you show your work.}
\begin{enumerate}
...
\item If $x>1$, and $y={\displaystyle \int_{1}^{x}\sqrt{1+\sqrt{t}}\,dt}$,
...
\item \label{enu:first-indefinite-int-prob}${\displaystyle \int\frac{2x}{10+x^{2}}\,dx}$\vfill
\item ${\displaystyle \int3xe^{-x}\,dx}$\vfill\newpage
\item ${\displaystyle \int\frac{dx}{\sqrt{4-x^{2}}}}$\vfill
\item ${\displaystyle \int\frac{dx}{(x-2)(x+4)}}$\vfill
\item \label{last-indef-int-prob}${\displaystyle \int\cos^{3}x\sin^{2}\,dx}$\vfill
...
\end{enumerate}
\end{multicols}
\item Solve the initial value problem, $\frac{dy}{dx}=\left(x+2\right)^{\nicefrac{1}{2}}$
and $y(0)=1$.\vfill
