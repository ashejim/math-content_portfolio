...
\yspace\columnbreak
\item the total number of possible outcomes
\item the probability of getting a head AND rolling a three. 
\item the odds of getting a head AND rolling a three.
\item the probability of getting a head OR rolling a three.
\item the odds of getting a head OR rolling a three. 
\end{enumerate}
\end{multicols}\vfill
\item A jar contains 30 jellybeans. $12$ are red and $18$ are blue. Jane
randomly picks $5$ jellybeans. Find the probability of each of the
following. \textbf{You only need to write the formulas.} \begin{multicols}{2}

\begin{enumerate}
\item all $5$ are blue.
\item None are blue.
\item exactly $2$ are blue.
\item at least $2$ are blue.
\end{enumerate}
\end{multicols}\vfill
...
\item You have been asked to play a game with a six-sided die. The rule
are as follows.
...
\item find the probability that a used car is Ford.
\item find the probability that a car on the lot is a Ford. 
\item find the probability that a car on the lot is not a Ford.
\end{enumerate}
\end{multicols}\vfill
...
a male boss?
\item What is the probability that a male worker has no preference for a
boss?
\end{enumerate}
\vfill
...
\item a biology major is taking Math but not art. 
