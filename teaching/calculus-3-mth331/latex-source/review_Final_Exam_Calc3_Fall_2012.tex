...
\renewcommand{\date}{Final Exam will be be given on January $15^{\text{th}}$ 5pm-7pm, 2012} %%\currenttime, \today
...
\begin{enumerate}[resume]
\item Let $f(x)=2\cos(x)$. Find the Taylor polynomial of order $n=3$ for
$f(x)$ centered at $0$.
...
\emph{Let $\mathbf{u}=\left\langle 2,4,1\right\rangle $ and $\mathbf{v}=\left\langle 1,-3,2\right\rangle $.
...
\begin{enumerate}[resume]
\item Find $g_{y}$ and $g_{y}$ for $g(x,y)=(x^{2}+2)e^{y}$.
