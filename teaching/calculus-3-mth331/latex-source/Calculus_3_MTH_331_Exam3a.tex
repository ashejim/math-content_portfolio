...
to $\mathbf{u}$.\xspace\xspace\xspace\vfill
\item Find the angle between $\mathbf{u}$ and $\mathbf{v}$.\xspace\xspace\xspace\vfill
\item \label{enu:Find-a-vector}Find a vector orthogonal to $\mathbf{u}$
and $\mathbf{v}$.\xspace\xspace\xspace\vfill
