...
\emph{n }greater than some index $N$. If ${\displaystyle \lim_{n\rightarrow\infty}a_{n}}={\displaystyle \lim_{n\rightarrow\infty}c_{n}=L}$,
then $\lim_{n\rightarrow\infty}b_{n}=L$.\vfill
