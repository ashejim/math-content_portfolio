...
\begin{enumerate}
\item Find the standard matrix $A$ for $T$.\Xspace \vfill
\end{enumerate}
\begin{enumerate}[resume]
...
a linear combination of $A$.\Xspace \vfill
\end{enumerate}
...
\end{enumerate}
\begin{enumerate}[resume]
\item Find another basis for $\R{2}$.\vfill
\item Is $\mathbf{v}_{1}=(1,2)$, $\mathbf{v}_{2}=(0,1)$, and $\mathbf{v}_{3}=(1,0)$
linearly independent? Explain.\vfill
...
\begin{enumerate}
\item Is $\{\mathbf{v}_{1},\mathbf{v}_{2},\mathbf{v}_{3}\}$ linearly independent?\xspace\Xspace \vfill
\end{enumerate}
\begin{enumerate}[resume]
\item Does $\{\mathbf{v}_{1},\mathbf{v}_{2},\mathbf{v}_{3}\}$ span $\R{3}$?,
i.e., does $\mbox{Span}(\mathbf{v}_{1},\mathbf{v}_{2},\mathbf{v}_{3})=\R{3}$?
Explain.\vfill
\item Find the dimension of $\mbox{Span}(\mathbf{v}_{1},\mathbf{v}_{2},\mathbf{v}_{3})$.\vfill
...
\begin{enumerate}
\item Is $V$ linearly independent or linearly dependent? Explain.\vfill
\end{enumerate}
\begin{enumerate}[resume]
\item Is $V$ a basis for $\mathbb{R}^{n}$? Explain. \vfill
\item Is $\mbox{Span}V$ a subspace of $\mathbb{R}^{n}$?\vfill
\end{enumerate}
