...
\textbf{Topics in Algebra~~|~~MTH 439 A~\,|~~Spring 2014}\\
\textbf{Tuesday \& Thursday 12:00-1:15~~|~~MAIN SHB 303}\\
...
\begin{center}
\emph{\textquotedbl Mathematics is the art of giving the same name
to different things.\textquotedbl}\\
\textasciitilde Henri Poincare, responding to \textquotedbl Poetry
is the art of giving different names to the same thing.\textquotedbl{}
\par\end{center}

\begin{center}
\emph{In our own time, in the period 1960-1980, we have seen particle
physics emerge as the playground of group theory.}\\
\textasciitilde Freeman Dyson
\par\end{center}
...
This is a \textbf{3 credit hour}\textbf{\emph{ }}course. Topics on
semi-groups and groups, rings, integral domains, finite fields, modules
over ring, and vector spaces over fields. Prerequisite: MTH 335. \textbackslash{}
...
Homework$=40\%$; Presentations$=20\%$; Midterm$=20\%$; Final $=20\%$
...
comprehensive exams; see the schedule below.\emph{ If beneficial,
the final exam score will replace the midterm exam score.}
...
\formatdate{17}{1}{2014} &  & Last day to add/drop\tabularnewline
\formatdate{4}{3}{2014} &  & Midterm\tabularnewline
\formatdate{1}{5}{2013} &  & Final Exam (10-12pm)\tabularnewline
 &  & \tabularnewline
\end{tabular}%
\end{minipage}

JCSU's academic calendar can be found here: \href{http://www.jcsu.edu/happenings/academic-calendar}{jcsu.edu/happenings/academic-calendar},
and the exam schedule can be found here: \href{http://www.jcsu.edu/happenings/exam-schedule/spring-exam}{http://www.jcsu.edu/happenings/exam-schedule/spring-exam}
...
\begin{center}
\emph{You know, for a mathematician, he did not have enough imagination.
But he has become a poet and now he is fine.}\\
\textasciitilde David Hilbert
\par\end{center}

\begin{center}
\emph{If you want to put the holes in your knowledge on display, try
teaching someone. }\\
\textasciitilde Linux guru Alan Cox
\par\end{center}
\end{document}
