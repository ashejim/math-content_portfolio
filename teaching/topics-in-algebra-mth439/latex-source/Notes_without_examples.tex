...
\include{Rings_without_examples}

\include{Homomorphisms_and_Isomorphisms_without_examples}

\include{ideals_without_examples}

\include{Factor_Rings_without_examples}
\end{document}
