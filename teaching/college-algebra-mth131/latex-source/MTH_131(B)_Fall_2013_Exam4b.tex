...
\textbf{You must show your work to receive. Each problem is worth
...
\item Find the domain of $f(x)$.\vfill\addtocounter{probs}{1}
\item Find the range of $f(x)$.\vfill\addtocounter{probs}{1}
\item \label{enu:Find-end}Find the horizontal asymptote of $f(x)$.\vfill\addtocounter{probs}{1}\columnbreak
...
$g(x)=\left(\frac{1}{\x}\right)^{x}\z$.\vfill\addtocounter{probs}{1}\columnbreak
\item []\renewcommand{\xmax}{10} 
\renewcommand{\xstep}{5}
\renewcommand{\ymax}{\xmax} 
\renewcommand{\ystep}{5}
...
\renewcommand{\Ro}{9} 
\renewcommand{\To}{20}
\renewcommand{\Ao}{1} {[}6 points{]} Find the accumulated value of an investment of \$\Po~at
\Ro\% interest compounded quarterly after \To~years.\vfill\addtocounter{probs}{1}
\end{enumerate}
\newpage
\begin{enumerate}[resume]
\item \renewcommand{\Po}{125,000} 
\renewcommand{\Ro}{4.5} 
\renewcommand{\To}{15}
...
\item \label{enu:last}\renewcommand{\Po}{1,000} 
\renewcommand{\Ro}{6.5} 
\renewcommand{\To}{10}
...
\renewcommand{\y}{100} 
\renewcommand{\z}{2}$\log_{\z}\x=\y$\xspace\addtocounter{probs}{1}
\item \renewcommand{\x}{2} 
\renewcommand{\y}{1} 
...
\renewcommand{\y}{64} 
\renewcommand{\z}{4}$\z^{\x}=\y$\xspace\addtocounter{probs}{1}
...
\renewcommand{\y}{1} 
\renewcommand{\z}{1}$\log_{6}6$\xspace\addtocounter{probs}{1}
\item \renewcommand{\x}{2} 
\renewcommand{\y}{1} 
\renewcommand{\z}{1}$e^{\ln3}$\xspace\addtocounter{probs}{1}
\item \renewcommand{\x}{2} 
\renewcommand{\y}{1} 
\renewcommand{\z}{1}$\log_{2}2^{12}$\xspace\addtocounter{probs}{1}
\item \renewcommand{\x}{2} 
\renewcommand{\y}{1} 
\renewcommand{\z}{1}$4^{\log_{4}10}$\xspace\addtocounter{probs}{1}
\item \renewcommand{\x}{2} 
\renewcommand{\y}{1} 
\renewcommand{\z}{1}$\log_{4}16$\xspace\addtocounter{probs}{1}
...
\renewcommand{\y}{1} 
\renewcommand{\z}{1}$\ln(x-3)$\addtocounter{probs}{1}
\end{enumerate}
\end{multicols}\xspace
\end{enumerate}
