...
\begin{axis}[height=5.5cm, 
	...
	\addplot[domain=\xmin:\xmax,thick,samples=100,draw=red,<->]{-1/2*x+3} node[pos=.65,above] {$$};
	\addplot[color=blue,solid,mark=*,style={font=\footnotesize}] coordinates {(-3,-5)} node[left] {$(-3,-5)$};
	\addplot[color=blue,solid,mark=*,style={font=\footnotesize}] coordinates {(0,3)} node[left] {$(0,3)$};;
	\addplot[color=blue,solid,mark=*,style={font=\footnotesize}] coordinates {(6,0)} node[above] {$(6,0)$};;
...
\begin{enumerate}[resume]
\item [\textbf{4.}]\setcounter{enumi}{5}$8x-5=11$
