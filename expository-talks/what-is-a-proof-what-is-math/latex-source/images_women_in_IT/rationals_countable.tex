...
% \tikzstyle{keepstyle} =[fill=white]
\tikzstyle{keepstyle2} =[rectangle, rounded corners,draw,text = red,fill=white]
\tikzstyle{keepstyle2} =[fill=white]
\tikzstyle{keepstyle3} =[rectangle, rounded corners, draw, fill=white]
\tikzstyle{keepstyle3} =[fill=white]
...
\node at (4,0) {$\vdots$};
\node  at (4,1) {$\frac{5}{5}$};
\node[keepstyle3] at (4,2) {$\frac{4}{5}$};
\node[keepstyle3] at (4,3) {$\frac{3}{5}$};
\node[keepstyle] (25) at (4,4) {$\frac{2}{5}$};
\node[keepstyle] (15) at (4,5) {$\frac{1}{5}$};
\node at (5,0) {$\vdots$};
\node[keepstyle3]  at (5,1) {$\frac{5}{6}$};
\node at (5,2) {$\frac{4}{6}$};
\node at (5,3) {$\frac{3}{6}$};
\node at (5,4) {$\frac{2}{6}$};
...
%%%%%%%%%%%%%%%%%%%%%%%
% \node[keepstyle2] at (0,5) {$1$};
% \node[keepstyle2] at (1,5) {$2$};
% \node[keepstyle2] at (0,4) {$3$};
% \node[keepstyle2] at (0,3) {$4$};
% \node[keepstyle2] at (2,5) {$5$};
% \node[keepstyle2] at (3,5) {$6$};
% \node[keepstyle2] at (2,4) {$7$};
% \node[keepstyle2] at (1,3) {$8$};
% \node[keepstyle2] at (0,2) {$9$};
% \node[keepstyle2] at (0,1) {$10$};
% \node[keepstyle2] at (4,5) {$11$};
% \node[keepstyle2] at (5,5) {$12$};
% \node[keepstyle2] at (4,4) {$13$};
% \node[keepstyle2] at (3,3) {$14$};
% \node[keepstyle2] at (2,2) {$15$};
% \node[keepstyle2] at (1,1) {$16$};
